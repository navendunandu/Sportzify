...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <div class="site-mobile-menu">
      <div class="site-mobile-menu-header">
        <div class="site-mobile-menu-logo">
          <a href="#"><img src="../Assets/Templates/Main/images/logo.png" alt="Image"></a>
        </div>
    ...
    <header class="site-navbar absolute transparent" role="banner">
      ...
      <nav class="site-navigation position-relative text-right bg-black text-md-right" role="navigation">
        <div class="container position-relative">
          <div class="site-logo">
            <a href="index.html"><img src="../Assets/Templates/Main/images/logo.png" alt="Hai"></a>
          </div>
       ...
       <li>
            ...
            <li><a href="UserBooking.php">UserBooking</a></li>
    ...
    <div class="slide-one-item home-slider owl-carousel">
      <div class="site-blocks-cover overlay" style="background-image: url(../Assets/Templates/Main/images/hero_bg_2.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row align-items-center justify-content-start">
            <div class="col-md-6 text-center text-md-left" data-aos="fade-up" data-aos-delay="400">
              <h1 class="bg-text-line"></h1>
              <p><a href="#" class="btn btn-primary btn-sm rounded-0 py-3 px-5"></a></p>
            </div>
          </div>
        </div>
      </div>  

      <div class="site-blocks-cover overlay" style="background-image: url(../Assets/Templates/Main/images/hero_bg_4.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row align-items-center justify-content-start">
            <div class="col-md-6 text-center text-md-left" data-aos="fade-up" data-aos-delay="400">
              <h1 class="bg-text-line"></h1>
      ...
      <div class="site-blocks-cover overlay" style="background-image: url(../Assets/Templates/Main/images/hero_bg_3.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row align-items-center justify-content-start">
            <div class="col-md-6 text-center text-md-left" data-aos="fade-up" data-aos-delay="400">
              <h1 class="bg-text-line"></h1>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 col-lg-4" >
            <div class="p-3 p-md-5 feature-block-1 mb-5 mb-lg-0 bg" style="background-image: url('../Assets/Templates/Main/images/img_1.jpg');">
              <div class="text">
                <h2 class="h5 text-white">SPORTZIFY THE SPORTS CORNER</h2>
                <p></p>
          ...
          <div class="col-md-6 col-lg-4">
            <div class="p-3 p-md-5 feature-block-1 mb-5 mb-lg-0 bg" style="background-image: url('../Assets/Templates/Main/images/img_2.jpg');">
              <div class="text">
                <h2 class="h5 text-white">SPORTZIFY THE ENTERTAINMENT HUB</h2>
                <p></p>
                <p class="mb-0"><a href="#" class="btn btn-primary btn-sm px-4 py-2 rounded-0">Read More</a></p>
              </div>
            </div>
          ...
          <div class="col-md-6 col-lg-4">
            <div class="p-3 p-md-5 feature-block-1 mb-5 mb-lg-0 bg" style="background-image: url('../Assets/Templates/Main/images/img_3.jpg');">
              <div class="text">
                <h2 class="h5 text-white">cricket</h2>
                <p></p>
                <p class="mb-0"><a href="#" class="btn btn-primary btn-sm px-4 py-2 rounded-0">Read More</a></p>
              </div>
            </div>
    ...
    <div class="site-blocks-vs site-section bg-light">
      <div class="container">
          ...
          <div class="ml-auto pr-4 order-md-2">
            <div class="h5 text-black text-uppercase text-center text-lg-left">
              <div class="d-block d-md-inline-block mb-3 mb-lg-0">
                <img src="../Assets/Templates/Main/images/img_1_sq.jpg" alt="Image" class="mr-3 image"><span class="d-block d-md-inline-block ml-0 ml-md-3 ml-lg-0">Sea Hawlks </span>
              </div>
              <span class="text-muted mx-3 text-normal mb-3 mb-lg-0 d-block d-md-inline ">vs</span> 
              <div class="d-block d-md-inline-block">
                <img src="../Assets/Templates/Main/images/img_3_sq.jpg" alt="Image" class="mr-3 image"><span class="d-block d-md-inline-block ml-0 ml-md-3 ml-lg-0">Patriots</span>
              </div>
            </div>
          </div>
        ...
        <div class="bg-image overlay-success rounded mb-5" style="background-image: url('../Assets/Templates/Main/images/hero_bg_1.jpg');" data-stellar-background-ratio="0.5">
          ...
          <div class="row align-items-center">
              ...
              <div class="text-center text-lg-left">
                <div class="d-block d-lg-flex align-items-center">
                  <div class="image mx-auto mb-3 mb-lg-0 mr-lg-3">
                    <img src="../Assets/Templates/Main/images/img_1_sq.jpg" alt="Image" class="img-fluid">
                  </div>
                  <div class="text">
                    <h3 class="h5 mb-0 text-black"></h3>
                    <span class="text-uppercase small country text-black"></span>
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-12 col-lg-4 text-center mb-4 mb-lg-0">
              <div class="d-inline-block">
                <p class="mb-2"><small class="text-uppercase text-black font-weight-bold"> &mdash; </small></p>
                <div class="bg-black py-2 px-4 mb-2 text-white d-inline-block rounded"><span class="h3"></span></div>
                <p class="mb-0"><small class="text-uppercase text-black font-weight-bold"></small></p>
              </div>
            </div>
              ...
              <div class="">
                <div class="d-block d-lg-flex align-items-center">
                  <div class="image mx-auto ml-lg-3 mb-3 mb-lg-0 order-2">
                    <img src="../Assets/Templates/Main/images/img_4_sq.jpg" alt="Image" class="img-fluid">
                  </div>
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <h2 class="h6 text-uppercase text-black font-weight-bold mb-3"></h2>
    ...
    <div class="site-section block-13 bg-primary fixed overlay-primary bg-image" style="background-image: url('../Assets/Templates/Main/images/hero_bg_3.jpg');"  data-stellar-background-ratio="0.5">

      <div class="container">
        <div class="row mb-5">
          <div class="col-md-12 text-center">
            <h2 class="text-white">More Game </h2>
          </div>
        </div>
          ...
          <div class="block-12">
            ...
            <div class="text">
              ...
              <div class="text-inner">
                <h2 class="heading mb-3"><a href="#" class="text-black"></a></h2>
                <p></p>
              </div>
            </div>
          </div>
        ...
        <div class="item">
          <div class="block-12">
            <figure>
              <img src="../Assets/Templates/Main/images/img_4.jpg" alt="Image" class="img-fluid">
            </figure>
            <div class="text">
              <span class="meta"></span>
              <div class="text-inner">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4">
            <div class="post-entry">
              ...
              <div class="text p-4">
                <h2 class="h5 text-black"><a href="#"></a></h2>
        ...
        <div class="row">
                  ...
                  <li class="mb-3">
                    <a href="#" class="d-flex">
                      <figure class="image mr-4">
                        <img src="../Assets/Templates/Main/images/img_1.jpg" alt="" class="img-fluid">
                      </figure>
                      <div class="text">
                        <h3 class="heading font-weight-light"></h3>
                      </div>
                    </a>
                  </li>
                  <li class="mb-3">
          ...
          <div class="col-lg-4 mb-5 mb-lg-0">
            <div class="mb-5">
              ...
              <div class="block-16">
                <figure>
                  <img src="../Assets/Templates/Main/images/img_1.jpg" alt="Image placeholder" class="img-fluid rounded">
                  <a href="https://vimeo.com/393122657" class="play-button popup-vimeo"><span class="icon-play"></span></a>
                </figure>
              </div>
            ...
            <div class="mb-5">
              <h3 class="footer-heading mb-2"></h3>
              <p></p>
