...
<table width="500" border="5">
  ...
  <?php
	$i=0;
	$selQry="select * from tbl_turf t inner join tbl_place p on t.place_id=p.place_id inner join tbl_district d on d.district_id=p.district_id where turf_vstatus=1";
